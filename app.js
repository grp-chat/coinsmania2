...
class GridSystem {
    constructor() {
        ...
        this.itemsArr = [
            ...
            this.item2 = new Item({itemLable: 20, itemId: "💰", takeInventorySpace: false}),
    ...
    setStartingPointForIsolatedLevels (player) {
    ...
    isThereAnItem(cellVal, plyrSlot) {
        ...
        if(getItemObject.itemId === "💰") {
            // io.emit('chat-to-clients', `${plyrSlot.id} got money!`);
            plyrSlot.wallet += 100;
...
io.sockets.on('connection', function (sock) {
    ...
    sock.on('goToNextLevel', () => {
        
        gridSystem.goToNextLevel();
